...
return [
    ...
    'custom' => [
        'reference_number' => [
            'regex' => 'يُسمح فقط بالأحرف الإنجليزية / الأحرف العربية / الأرقام / الشرطة السفلية / الواصلة / المسافة / الشرطة المائلة',
        ],
        'company_unique_name' => [
        ...
        'order_cost_amount_tiers_range' => 'يجب أن تكون بداية قيمة الطلب أكبر من نهاية القيمه السابقة بـ 0.01 فقط',
    ],
