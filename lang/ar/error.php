...
return [
    ...
    'phone_number_does_not_belong_to_national_id' => 'رقم الهاتف لا ينتمي لهذه الهوية',
    'invalid_person_id' => 'رقم الهوية غير صحيح',
    'person_id_not_found' => 'رقم الهوية غير موجود',
    'invalid_mobile_number' => 'رقم الهاتف غير صحيح',
    'invalid_request_format' => 'صيغة الطلب JSON غير صحيحة',
    'invalid_api_key' => 'API key غير صحيح',
    'service_not_available' => 'خدمة التحقق من الهوية TCC غير متاحة',
