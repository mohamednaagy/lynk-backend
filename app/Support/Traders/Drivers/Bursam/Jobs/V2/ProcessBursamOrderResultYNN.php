...
class ProcessBursamOrderResultYNN implements ShouldBeUnique, ShouldQueue
{
    ...
    public function handle(): void
    {
        DB::transaction(function () {
            ...
            Log::channel('tracking_bursam')->info('Purchasing Step => Starting ProcessBursamOrderResultYNN Job', ['financingOrderId' => $traderOrder->order->id, 'traderOrderId' => $this->traderOrderId]);
