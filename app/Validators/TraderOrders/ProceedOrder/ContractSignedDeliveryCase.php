...
class ContractSignedDeliveryCase implements TraderOrderProceedCase
{
    public function canProceed(TraderOrder $traderOrder, bool $forceToProceed = false): bool
    {
        if (
            ...
            Log::channel(getSuitableLoggingFromTraderProvider($traderOrder))->error(formatLogTitle('ContractSignedDeliveryCase: traderOrderId: '.$traderOrder->id.' - can not proceed', $traderOrder), [
