...
class ClearEligibleFlagAndRefreshInventory extends BaseStatus implements ShouldBeUnique, ShouldQueue
{
    ...
    /**
     * Flip is_editable to 1 (transaction + lock), then refresh stock after commit.
     */
    private function updateInventoryEditabilityAndRefreshStock(int $orderId, int $inventoryId): void
    {
        DB::transaction(function () use ($inventoryId, $orderId) {
