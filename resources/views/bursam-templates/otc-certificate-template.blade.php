...
<div class="container">
    <div class="header">
        <img src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('color-logo.png'))) }}" alt="Logo" width="150">
    ...
    <div class="details">
        ...
        <table class="table">
            ...
            <tr>
                <td>Murabha Value:</td>
                <td>{{ number_format((float) $murabaha_value, 2) }} {{ $currency }}</td>
            </tr>
{{--            <tr>--}}
{{--                <td>Product Price:</td>--}}
