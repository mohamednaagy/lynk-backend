        ...
        <div class="divide-y divide-gray-300/50">
            <div class="py-8 space-y-6 text-base leading-7">
                ...
                <p class="text-lg text-right text-black">
                    {{ $company_name }} سيكون مسؤولا عن رسوم التخزين والحفظ خلال مدة تملك السلعة.
            ...
            <div class="flex flex-row justify-between pt-8 font-semibold">
                ...
                <div class="flex flex-row-reverse gap-0.5">
                    <p class="text-right text-[11px] text-cyan-900">,3781</p>
                    <p class="text-right text-[11px] text-cyan-900">الملك عبدالله ابن عبدالعزيز سعود الفرعي  حي الملك فهد 6460</p>
                </div>
