...
<body dir="rtl">
    <div class="flex justify-end">
        <img class="h-20" src="https://dev-api.uselynk.com/color-logo.png" alt="">
    </div>
        ...
        <div class="divide-y divide-gray-300/50">
            <div class="py-8 space-y-6 text-base leading-7">
                ...
                <p class="text-lg text-right text-black">
                    ...
                    من
                    <Settings> {{ $default_contract_sign_time_limit }}
                        ساعة.
                ...
                <div class="flex justify-end">
                    <img class="h-20" src="https://dev-api.uselynk.com/radised-logo.png" alt="">
                </div>
            </div>
