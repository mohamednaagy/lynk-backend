...
use App\Http\Controllers\Api\V1\Lender\Orders\FetchPurchasingCommodity;
...
use App\Http\Controllers\Api\V1\Lender\Orders\UpdatePurchasingCommodity;
        ...
        function () {
            ...
            Route::middleware('verified.email:'.Area::Lender)->group(function () {
                Route::middleware('checkCompanyStatus')->group(function () {
                    ...
                    Route::get('orders/{order}/purchasing_commodity', FetchPurchasingCommodity::class);
                    Route::put('orders/{order}/purchasing_commodity/{traderOrder}', UpdatePurchasingCommodity::class);
