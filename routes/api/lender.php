...
use App\Http\Controllers\Api\V1\Lender\Orders\FinancialProductsLiteList;
    ...
    Route::middleware([
        ...
        function () {
            ...
            Route::middleware('verified.email:'.Area::Lender)->group(function () {
                ...
                Route::get('/financial-products/dropdown-list', [FinancialProductsLiteList::class , 'index']);
