...
class ProcessBursamSellingCommodityToOpenMarketForCancellationTest extends TestCase
{
    ...
    public function test_selling_commodity_to_open_market_for_cancellation_success()
    {
        Event::fake();
        Http::fake(function () {
    ...
    public function test_selling_commodity_to_open_market_for_cancellation_failed()
    {
        Http::fake(function () {
            return Http::response([
                'header' => [
