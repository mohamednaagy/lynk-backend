...
{
    use RefreshDatabase, InteractsWithTrader, InteractsWithAdmin;
    ...
    public function setUp(): void
    {
        ...
        self::$userManager = $this->createManager(
            'manager@bim.com',
            perm(Area::SuperAdmin, [Subject::TraderUsers, Action::Edit]),
        );
        self::$userTraderAdmin = $this->createTraderUser(self::$company->id, Role::TraderAdmin, 'TraderAdmin@bim.com');
