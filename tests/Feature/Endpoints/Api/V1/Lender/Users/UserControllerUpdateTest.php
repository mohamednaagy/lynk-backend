...
class UserControllerUpdateTest extends TestCase
{
    ...
    public function test_change_and_re_verify_email_successful(): void
    {
        ...
        Mail::assertQueued(ChangeEmail::class, function ($mail) {
            return $mail->hasTo(self::$userLenderSupervisor->email);
        });

        $this->assertDatabaseHas('users', [
            'id' => self::$userLenderSupervisor->id,
            'email' => self::$lenderDetails['email'],
            'email_verified_at' => null,
        ]);
